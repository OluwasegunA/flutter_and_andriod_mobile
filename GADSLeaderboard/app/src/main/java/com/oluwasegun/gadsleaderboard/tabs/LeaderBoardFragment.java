...
import com.oluwasegun.gadsleaderboard.LeaderBoardAdapter;
...
public class LeaderBoardFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        final LeaderBoardAdapter adapter = new LeaderBoardAdapter(getContext());
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(adapter);

        dataViewModel.topLearnerMutableData.observe((LifecycleOwner) Objects.requireNonNull(getContext()){
            @Override
